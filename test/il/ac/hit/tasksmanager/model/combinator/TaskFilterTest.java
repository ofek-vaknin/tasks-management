...
public class TaskFilterTest {
    ...
    public void matchesByTitle() {
        Task t = new BasicTask(1, "Buy milk", "2%", new ToDoState(), LocalDate.of(2025, 1, 10));
    ...
    public void matchesByStateCaseInsensitive() {
        Task t = new BasicTask(2, "Implement feature", null, new InProgressState(), null);
    ...
    public void matchesByDueDate() {
        ...
        Task t = new BasicTask(3, "Pay bills", null, new CompletedState(), due);
    ...
    public void andOrCombinators() {
        Task a = new BasicTask(4, "Alpha", null, new ToDoState(), null);
        Task b = new BasicTask(5, "Beta", null, new ToDoState(), null);
